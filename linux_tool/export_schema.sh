...
$MysqlDir/mysqldump -d -h$v_host -u$v_user -p$v_password --single-transaction --flush-logs  --databases $database>$Full_Backup/export_schema_$(date +%Y%m%d)_$(date +%H).schema.sql
